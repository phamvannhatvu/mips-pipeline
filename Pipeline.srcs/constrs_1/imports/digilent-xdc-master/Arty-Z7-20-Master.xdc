...
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets -of [get_ports { SYS_clk }]]
## Switches
set_property -dict { PACKAGE_PIN M20    IOSTANDARD LVCMOS33 } [get_ports { SYS_clk }]; #IO_L7N_T1_AD2N_35 Sch=SW0
...
## LEDs
#set_property -dict { PACKAGE_PIN R14    IOSTANDARD LVCMOS33 } [get_ports { SYS_leds }]; #IO_L6N_T0_VREF_34 Sch=LED0
...
set_property -dict { PACKAGE_PIN D20    IOSTANDARD LVCMOS33 } [get_ports { SYS_load }]; #IO_L4N_T0_35 Sch=BTN1
