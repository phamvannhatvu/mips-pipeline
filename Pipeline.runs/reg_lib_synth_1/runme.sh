...
HD_PWD='D:/Studying/Academic/HCMUT/222/ComputerArchitecture/Assignments/ThayBinh/Mips_Pipeline/Pipeline.runs/reg_lib_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log reg_lib.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source reg_lib.tcl
